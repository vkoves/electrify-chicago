...
/**
 * A single entry in the building search autocomplete index, generated by the
 * data pipeline (src/data/scripts/generate_search_index.py) and fetched on
 * demand from /building-search-index.csv. `path` is derived from the building
 * id as /building-id/:id, which redirects to the canonical building page.
 */
...
/**
 * Parse a single CSV line into its fields, handling quoted fields that may
