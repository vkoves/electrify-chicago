...
@Prop({ type: Array<IBuildingNode>, default: '' })
  ...
  /**
   * Map the default buildings which is the top `BuildingsMap.MaxBuildingsCount` buildings sorted by
   * GHG intensity
   */
  mapDefaultBuildings(): void {
    ...
    const topBuildings = buildingNodes.slice(0, BuildingsMap.MaxBuildingsCount);
