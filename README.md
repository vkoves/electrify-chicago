...
```bash
# Generate ALL social images (buildings + pages) - RECOMMENDED
...
**Social Images**: The site generates two types of custom 1200x630px social media images:
...
Both are generated by screenshotting custom Vue components using Puppeteer, ensuring consistent design with the rest of the site.
